...
public class LeaveDaoImpl implements ILeaveDao {
    ...
    private LeaveApplication mapRow(ResultSet rs) throws SQLException {
        ...
        l.setStartDate(toLocalDate(rs.getDate("start_date")));
        l.setEndDate(toLocalDate(rs.getDate("end_date")));

        l.setReason(rs.getString("reason"));
        l.setStatus(rs.getString("status"));

        l.setAppliedOn(toLocalDateTime(rs.getTimestamp("applied_on")));

        Integer approvedBy = rs.getInt("approved_by");
        l.setApprovedBy(rs.wasNull() ? null : approvedBy);
